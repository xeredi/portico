...
public enum MessageI18nKey {
	...
	/** The enti_cmd baja. */
	enti_cmdBaja,
	/** The enti_cmd edicion. */
	enti_cmdEdicion,
	/** The enti_cmd duplicado. */
	enti_cmdDuplicado,
	/** The enti_max grid. */
	enti_maxGrid,
	...
	/** The entd_span lg. */
	entd_spanLg,
	/** The entd_obligatorio. */
	entd_obligatorio,
	/** The entd_gridable. */
	entd_gridable,
	/** The entd_filtrable. */
	entd_filtrable,
	/** The entd_valor defecto. */
	entd_valorDefecto,
	/** The entd_etiqueta. */
	entd_etiqueta,
	/** The entd validacion. */
	...
	/** The Html tipo_ ta. */
	HtmlTipo_TA,
	/** The Elemento tipo_ nd. */
	ElementoTipo_ND,
	/** The Elemento tipo_ ne. */
	ElementoTipo_NE,
	/** The Elemento tipo_ tx. */
	ElementoTipo_TX,
	/** The Elemento tipo_ fe. */
	ElementoTipo_FE,
	/** The Elemento tipo_ fh. */
	ElementoTipo_FH,
	/** The Elemento tipo_ pr. */
	ElementoTipo_PR,
	/** The Elemento tipo_ bo. */
	ElementoTipo_BO,
	/** The Elemento tipo_ cr. */
	ElementoTipo_CR,
	/** The Elemento tipo_ sr. */
	ElementoTipo_SR,
	/** The cdrf. */
	cdrf,
	/** The cdrf list. */
	...
	prbt_erroresCnt,
	/** The prbt_alertas cnt. */
	prbt_alertasCnt,
	/** The prbt_mensajes cnt. */
	prbt_mensajesCnt,
	/** The prmn list. */
	prmn,
	/** The prmn list. */
	...
	E00005,
	/**
	 * Error de rango de vigencia de un parametro, Fecha fin debe ser posterior
	 * a fecha inicio. sin argumentos.
	 */
	E00006,
	/**
	 * Instancia no encontrada. Se pasan como argumentos el nombre de la entidad
	 * de la instancia y su identificador.
	 */
	E00008,
	/**
	 * Error de solape de rangos de vigencia de una entidad. Se pasa como
	 * argumento el nombre de la entidad.
	 */
	E00009,
	/**
	 * Error de subservicio en estado inválido para realizar una acción. Se pasa
	 * como argumento el estado del subservicio.
	 */
	E00011,
	/**
	 * Error de valor no perteneciente a una lista de valores válidos. Se pasa
	 * como argumento el nombre del campo y la lista de valores válidos.
	 */
	E00012,
	/**
	 * Error de operacion no permitida. Por ejemplo, finalizar un atraque que no
	 * puede ser finalizado, o cancelar un proceso batch en curso...
	 */
	E00013,
