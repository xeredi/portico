...
public class EntidadVO {
    ...
    /**
     * {@link List} de Ids de tipos de dato asociados a una entidad, ordenados por grupo de dato,
     * fila y orden dentro de la fila.
     */
    private List<Long> entdList;

    /**
     * {@link Map} de tipos de dato asociados a una entidad, indexados por el identificador de tipo
     * de dato.
     */
     ...
     *
     * @param value the new cmd edicion
     */
     ...
     *
     * @param value the new cmd duplicado
     */
