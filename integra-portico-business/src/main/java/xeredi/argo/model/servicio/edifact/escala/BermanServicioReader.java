...
public final class BermanServicioReader extends BermanD14bBaseVisitor {
     ...
     *            the anif map
     */
    public BermanServicioReader(final Map<Entidad, Map<String, ParametroVO>> amaestroMap,
            final Map<String, ParametroVO> anifMap) {
        super();
     ...
     */
    @Override
    public Object visitBerman(final BermanContext ctx) {
        final TipoServicioDetailVO tpsrDetail = TipoServicioProxy.select(Entidad.ESCALA.getId());

        srvc = tpsrDetail.createItem();

        final TipoParametroDetailVO tpprDetail = TipoParametroProxy.select(Entidad.BUQUE.getId());

        buque = tpprDetail.createItem();
    ...
    public Object visitFtx(final FtxContext ctx) {
        ...
        case "AAI":
            srvc.addItdt(TipoDato.CADENA_06.getId(), ctx.c108().f4440(0).getText());
        ...
        case "ACB":
            if (ctx.c107() != null) {
                ...
                case "Z2C":
                    ...
                    break;
                case "ZOB":
                    buque.addItdt(TipoDato.CADENA_03.getId(), ctx.c108().f4440(0).getText());
                ...
                case "ZOI":
                    ...
                    srvc.addItdt(TipoDato.CADENA_12.getId(), ctx.c108().f4440(0).getText());
     ...
     */
    @Override
    public Object visitQty(final QtyContext ctx) {
        switch (ctx.c186().f6063().getText()) {
        case "ZDP":
            buque.addItdt(TipoDato.ENTERO_15.getId(), parseLong(ctx.c186().f6060()));

            break;
        case "ZTE":
            srvc.addItdt(TipoDato.ENTERO_01.getId(), parseLong(ctx.c186().f6060()));

            break;
        case "ZTS":
            srvc.addItdt(TipoDato.ENTERO_03.getId(), parseLong(ctx.c186().f6060()));

            break;
        case "ZWE":
            srvc.addItdt(TipoDato.ENTERO_06.getId(), parseLong(ctx.c186().f6060()));

            break;
        case "ZWS":
            srvc.addItdt(TipoDato.ENTERO_07.getId(), parseLong(ctx.c186().f6060()));

            break;
        case "ZPE":
            srvc.addItdt(TipoDato.ENTERO_04.getId(), parseLong(ctx.c186().f6060()));

            break;
        case "ZPS":
            srvc.addItdt(TipoDato.ENTERO_05.getId(), parseLong(ctx.c186().f6060()));
    ...
    public Object visitNad(final NadContext ctx) {
        ...
        case "CV":
            srvc.addItdt(TipoDato.ORGA_3.getId(), getOrganizacion(ctx.c082().f3039().getText()));

            break;
        case "TR":
            operacionActual.addItdt(TipoDato.ORGA.getId(), getOrganizacion(ctx.c082().f3039().getText()));
    ...
    public Object visitTdt(final TdtContext ctx) {
        ...
        buque.addItdt(TipoDato.PAIS.getId(), getMaestro(Entidad.PAIS, ctx.c222().f8453().getText()));

        final ParametroVO tipoBuqueEdi = getMaestro(Entidad.TIPO_BUQUE_EDI, ctx.c001().f8179().getText());
    ...
    public Object visitRff(final RffContext ctx) {
        ...
        case "VM":
            buque.addItdt(TipoDato.CADENA_02.getId(), ctx.c506().f1154().getText());

            break;
        case "ZIO":
            buque.addItdt(TipoDato.CADENA_06.getId(), ctx.c506().f1154().getText());

            break;
        case "ZIC":
            buque.addItdt(TipoDato.CADENA_05.getId(), ctx.c506().f1154().getText());

            break;
        case "ZSC":
            buque.addItdt(TipoDato.CADENA_04.getId(), ctx.c506().f1154().getText());
        ...
        case "ZNG":
            ...
            break;
        case "ZSB":
            buque.addItdt(TipoDato.ENTERO_05.getId(), parseLong(ctx.c506().f1154()));
    ...
    public Object visitDtm(final DtmContext ctx) {
        ...
        case "36":
            ...
            break;
        case "183":
            buque.addItdt(TipoDato.FECHA_03.getId(), parseDate(ctx.c507().f2380(), "yyyyMMdd"));

            break;
        case "379":
            buque.addItdt(TipoDato.FECHA_05.getId(), parseDate(ctx.c507().f2380(), "yyyyMMdd"));

            break;
        case "178":
            atraqueActual.setFini(parseDate(ctx.c507().f2380(), "yyyyMMddHHmm"));

            break;
        case "189":
            atraqueActual.setFfin(parseDate(ctx.c507().f2380(), "yyyyMMddHHmm"));
    ...
    public Object visitMea(final MeaContext ctx) {
        ...
        case "AAE":
            ...
            case "ZMD":
                buque.addItdt(TipoDato.DECIMAL_02.getId(), parseDouble(ctx.c174().f6314()));

                break;
            case "WM":
                buque.addItdt(TipoDato.DECIMAL_04.getId(), parseDouble(ctx.c174().f6314()));

                break;
            case "HM":
                buque.addItdt(TipoDato.DECIMAL_05.getId(), parseDouble(ctx.c174().f6314()));

                break;
            case "HT":
                buque.addItdt(TipoDato.DECIMAL_06.getId(), parseDouble(ctx.c174().f6314()));

                break;
            case "ZMP":
                buque.addItdt(TipoDato.ENTERO_06.getId(), parseLong(ctx.c174().f6314()));

                break;
            case "ZTL":
                buque.addItdt(TipoDato.UNID_MED_SBT.getId(), ctx.c174().f6411().getText());
                buque.addItdt(TipoDato.ENTERO_05.getId(), parseLong(ctx.c174().f6314()));

                break;
            case "ZAD":
                atraqueActual.addItdt(TipoDato.DECIMAL_03.getId(), parseDouble(ctx.c174().f6314()));

                break;
            case "ZDD":
                atraqueActual.addItdt(TipoDato.DECIMAL_04.getId(), parseDouble(ctx.c174().f6314()));

                break;
            case "WT":
            case "AAW":
            case "LM":
                operacionActual.addItdt(TipoDato.UNID_MED_BERMAN.getId(), ctx.c174().f6411().getText());
                operacionActual.addItdt(TipoDato.DECIMAL_02.getId(), parseDouble(ctx.c174().f6314()));
        ...
        case "LAO":
            switch (ctx.c502().f6313().getText()) {
            case "LM":
                buque.addItdt(TipoDato.DECIMAL_03.getId(), parseDouble(ctx.c174().f6314()));
        ...
        case "WT":
            switch (ctx.c502().f6313().getText()) {
            case "AAM":
                buque.addItdt(TipoDato.ENTERO_01.getId(), parseLong(ctx.c174().f6314()));

                break;
            case "ZDW":
                buque.addItdt(TipoDato.ENTERO_04.getId(), parseLong(ctx.c174().f6314()));
        ...
        case "ABS":
            switch (ctx.c502().f6313().getText()) {
            case "ZVC":
                buque.addItdt(TipoDato.DECIMAL_07.getId(), parseDouble(ctx.c174().f6314()));

                break;
            case "ZVM":
                buque.addItdt(TipoDato.DECIMAL_08.getId(), parseDouble(ctx.c174().f6314()));
        ...
        case "CT":
            switch (ctx.c502().f6313().getText()) {
            case "ZHE":
                buque.addItdt(TipoDato.ENTERO_10.getId(), parseLong(ctx.c174().f6314()));

                break;
            case "U":
                operacionActual.addItdt(TipoDato.UNID_MED_BERMAN.getId(), ctx.c174().f6411().getText());
                operacionActual.addItdt(TipoDato.DECIMAL_01.getId(), parseDouble(ctx.c174().f6314()));
        ...
        case "ACG":
            switch (ctx.c502().f6313().getText()) {
            case "ZVL":
                srvc.addItdt(TipoDato.ENTERO_10.getId(), parseLong(ctx.c174().f6314()));
    ...
    public Object visitLoc(final LocContext ctx) {
        ...
        case "153":
            ...
            break;
        case "92":
            srvc.addItdt(TipoDato.UNLOCODE_2.getId(), getMaestro(Entidad.UNLOCODE, ctx.c517().f3225().getText()));

            break;
        case "61":
            srvc.addItdt(TipoDato.UNLOCODE.getId(), getMaestro(Entidad.UNLOCODE, ctx.c517().f3225().getText()));

            break;
        case "229":
            buque.addItdt(TipoDato.UNLOCODE.getId(), getMaestro(Entidad.UNLOCODE, ctx.c517().f3225().getText()));
    ...
    public Object visitDoc(final DocContext ctx) {
        ...
        case "ZCA":
            if (ctx.c503() != null) {
                buque.addItdt(TipoDato.CADENA_09.getId(), ctx.c503().f1004().getText());
            }
     ...
     */
    @Override
    public Object visitTsr(final TsrContext ctx) {
        final TipoSubservicioDetailVO tpssDetail = TipoSubservicioProxy.select(Entidad.ATRAQUE.getId());

        atraqueActual = tpssDetail.createItem();
        ...
        if (!"SEC".equals(codigoAtraque)) {
            atraqueActual.addItdt(TipoDato.TIPO_ATR_EDI.getId(),
                    getMaestro(Entidad.TIPO_ATRAQUE_EDI, ctx.c233().f7273(1).getText()));
            ...
            atraqueActual.addItdt(TipoDato.DECIMAL_03.getId(), buque.getItdt(TipoDato.DECIMAL_02.getId())
                    .getCantidadDecimal());
            atraqueActual.addItdt(TipoDato.DECIMAL_04.getId(), buque.getItdt(TipoDato.DECIMAL_02.getId())
                    .getCantidadDecimal());
     ...
     */
    @Override
    public Object visitPoc(final PocContext ctx) {
     ...
     */
    @Override
    public Object visitHan(final HanContext ctx) {
        final TipoSubservicioDetailVO tpssDetail = TipoSubservicioProxy.select(Entidad.OPERACION_ATRAQUE.getId());

        operacionActual = tpssDetail.createItem();
     ...
     */
    @Override
    public Object visitGds(final GdsContext ctx) {
        operacionActual.addItdt(TipoDato.TIPO_MERC.getId(),
                getMaestro(Entidad.TIPO_MERCANCIA, ctx.c703().f7085().getText()));
