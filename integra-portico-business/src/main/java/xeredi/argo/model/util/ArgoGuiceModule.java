...
import xeredi.argo.model.metamodelo.service.TipoParametroProxyServiceImpl;
...
import xeredi.argo.model.metamodelo.service.TipoSubservicioProxyService;
import xeredi.argo.model.metamodelo.service.TipoSubservicioProxyServiceImpl;
...
public final class ArgoGuiceModule extends MyBatisModule {
	...
	protected void initialize() {
		...
		bind(TipoParametroProxyService.class).to(TipoParametroProxyServiceImpl.class).in(Singleton.class);
		...
		bind(TipoSubservicioProxyService.class).to(TipoSubservicioProxyServiceImpl.class).in(Singleton.class);
