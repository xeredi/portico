...
/**
 * The Class PeriodoProcesoServiceImpl.
 */
@Singleton
@Transactional
public class PeriodoProcesoServiceImpl implements PeriodoProcesoService {

	/** The Constant LOG. */
	private static final Log LOG = LogFactory.getLog(PeriodoProcesoServiceImpl.class);
