					...
					case PR:
						if (isLast) {
							...
							case LABEL:
								...
								// "(SELECT CONCAT(CONCAT(prmt_parametro , ' -
								// '), COALESCE("
								// +
								// "(SELECT i18n_text FROM tbl_i18n_i18n WHERE
								// i18n_pref='prvr' AND i18n_lang
								// = 'es' AND i18n_ext_pk = ("
								// +
								// "SELECT prvr_pk FROM
								// tbl_parametro_version_prvr WHERE prvr_prmt_pk
								// =
								// prmt_pk AND fref BETWEEN prvr_fini AND
								// COALESCE(prvr_ffin, fref))), 'NO
								// i18n!!!'))"
								// + " FROM tbl_parametro_prmt WHERE prmt_pk = "
								// + fieldPrefix + "prmt_pk)";
