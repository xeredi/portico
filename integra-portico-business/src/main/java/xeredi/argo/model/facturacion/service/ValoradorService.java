...
public class ValoradorService {
	/** The Constant LOG. */
	private static final Log LOG = LogFactory.getLog(ValoradorService.class);

	/** The aspc DAO. */
	private final AspectoDAO aspcDAO;

	/** The vlrt DAO. */
	private final ValoracionTemporalDAO vlrtDAO;
	...
	/** The contexto DAO. */
	private final ValoradorContextoDAO contextoDAO;
	...
	/** The vlra DAO. */
	private final ValoracionAgregadaDAO vlraDAO;
	...
	/**
	 * Instantiates a new valorador service.
	 *
	 * @param aspcDAO
	 *            the aspc DAO
	 * @param vlrtDAO
	 ...
	 */
	@Inject
	public ValoradorService(final AspectoDAO aspcDAO, final ValoracionTemporalDAO vlrtDAO, final ServicioDAO srvcDAO,
			final CargoDAO crgoDAO, final ValoradorContextoDAO contextoDAO, final ValoracionDAO vlrcDAO,
			final ValoracionLineaDAO vlrlDAO, final ValoracionDetalleDAO vlrdDAO, final ValoracionAgregadaDAO vlraDAO,
			final ReglaDAO rglaDAO, final EntidadProxyService entiProxy) {
		super();
		this.aspcDAO = aspcDAO;
		this.vlrtDAO = vlrtDAO;
		this.srvcDAO = srvcDAO;
		this.crgoDAO = crgoDAO;
		this.contextoDAO = contextoDAO;
		this.vlrcDAO = vlrcDAO;
		this.vlrlDAO = vlrlDAO;
		this.vlrdDAO = vlrdDAO;
		this.vlraDAO = vlraDAO;
	 ...
	 * @return the list
	 */
	private List<Long> aplicarAspecto(final @NonNull ValoradorContextoVO vldrContexto) {
