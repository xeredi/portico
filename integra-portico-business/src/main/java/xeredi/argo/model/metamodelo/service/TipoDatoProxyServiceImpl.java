...
/**
 * The Class TipoDatoProxyServiceImpl.
 */
public class TipoDatoProxyServiceImpl implements TipoDatoProxyService {
	/** The Constant LOG. */
	private static final Log LOG = LogFactory.getLog(TipoDatoProxyServiceImpl.class);
