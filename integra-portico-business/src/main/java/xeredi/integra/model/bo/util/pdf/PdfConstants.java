...
public final class PdfConstants {
	...
	public static final StyleBuilder LABEL_STYLE = DynamicReports.stl
			.style()
			.setFontSize(9)
			.setBorder(DynamicReports.stl.pen1Point().setLineColor(Color.WHITE))
			.setBackgroundColor(Color.LIGHT_GRAY).setPadding(3);

	/** The Constant VALUE_STYLE. */
	public static final StyleBuilder VALUE_STYLE = DynamicReports.stl.style()
			.setFontSize(9).setPadding(3);

	/** The Constant TH_STYLE. */
	public static final StyleBuilder TH_STYLE = DynamicReports.stl
			.style()
			.setFontSize(9)
			.setBorder(DynamicReports.stl.pen1Point().setLineColor(Color.WHITE))
			.setBackgroundColor(Color.LIGHT_GRAY).setPadding(2);
