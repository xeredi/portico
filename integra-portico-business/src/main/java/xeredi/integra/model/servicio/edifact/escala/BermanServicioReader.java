...
import xeredi.integra.model.servicio.grammar.escala.BermanD14bParser.DocContext;
import xeredi.integra.model.servicio.grammar.escala.BermanD14bParser.DtmContext;
import xeredi.integra.model.servicio.grammar.escala.BermanD14bParser.FtxContext;
...
import xeredi.integra.model.servicio.grammar.escala.BermanD14bParser.MeaContext;
...
import xeredi.integra.model.servicio.grammar.escala.BermanD14bParser.QtyContext;
...
public final class BermanServicioReader extends BermanD14bBaseVisitor {
     ...
     *            the anif map
     */
    public BermanServicioReader(Map<Entidad, Map<String, ParametroVO>> amaestroMap,
    ...
    public Object visitFtx(FtxContext ctx) {
        ...
        case "AAI":
            ...
            // FIXME Pueden ser Lugar de embarque/desembarque de operacion de atraque o fondeo
    ...
    public Object visitTsr(TsrContext ctx) {
        atraqueActual = new SubservicioVO(TipoSubservicioProxy.select(Entidad.ATRAQUE.getId()));
        ...
        if (!"SEC".equals(codigoAtraque)) {
            ...
            atraqueActual.addItdt(TipoDato.DECIMAL_03.getId(),
                    buque.getItdt(TipoDato.DECIMAL_02.getId()).getCantidadDecimal());
    ...
    public Object visitHan(HanContext ctx) {
        operacionActual = new SubservicioVO(TipoSubservicioProxy.select(Entidad.OPERACION_ATRAQUE.getId()));
