...
ifcsum
:
	s_UNH ["IFCSUM"] s_BGM s_DTM* s_MOA* s_FTX* s_CNT* s_PCD? s_GDS* gr_1* gr_2*
	gr_4* gr_7* gr_8* gr_9* gr_23* gr_27* s_UNT
;
...
gr_9
:
	s_TDT s_DTM* gr_10* gr_11* s_SEL* s_FTX* gr_12* gr_13* gr_5* gr_15* gr_8*
	gr_1* gr_18*
;
...
:
	...
	s_FTX* s_RFF* s_PCD* gr_24* gr_25* gr_5*
;
...
gr_27
:
	s_CNI gr_28* gr_30* s_CTA? s_COM* s_DTM* s_CNT* s_TSR* s_CUX* s_PCD* s_MOA*
	s_FTX* s_GDS* gr_11* gr_33* gr_1* gr_2* gr_37* gr_38* gr_8* gr_40* gr_46*
	gr_53* gr_73*
;
...
gr_53
:
	s_GID s_HAN? s_TMP? s_RNG? s_TMD? s_LOC* s_MOA* s_PIA* s_GIN* s_FTX* gr_54*
	gr_12* gr_13* gr_1* gr_58* gr_59* gr_2* gr_30* gr_64* gr_7* gr_8*
;
