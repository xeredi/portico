...
public final class ReglaSaveAction extends CrudSaveAction<ReglaVO> {
	...
	public void doSave() throws ApplicationException {
		switch (accion) {
		case create:
			rglaService.insert(model, i18nMap);

			break;
		case edit:
			rglaService.update(model, i18nMap);
	...
	public void doValidate() throws ApplicationException {
		...
		if (ReglaTipo.T == model.getTipo()) {
			FieldValidator.validateRequired(this, MessageI18nKey.rgla_pathImpuesto,
					model.getVersion().getPathImpuesto());
			FieldValidator.validateRequired(this, MessageI18nKey.rgla_pathPagador, model.getVersion().getPathPagador());
			FieldValidator.validateRequired(this, MessageI18nKey.rgla_pathEsSujPasivo,
					model.getVersion().getPathEsSujPasivo());
			...
			if (!GenericValidator.isBlankOrNull(model.getVersion().getEtiqCuant1())
				...
				FieldValidator.validateRequired(this, MessageI18nKey.rgla_etiqCuant1,
						model.getVersion().getEtiqCuant1());
				FieldValidator.validateRequired(this, MessageI18nKey.rgla_pathCuant1,
						model.getVersion().getPathCuant1());
			}
			...
			if (!GenericValidator.isBlankOrNull(model.getVersion().getEtiqCuant2())
				...
				FieldValidator.validateRequired(this, MessageI18nKey.rgla_etiqCuant2,
						model.getVersion().getEtiqCuant2());
				FieldValidator.validateRequired(this, MessageI18nKey.rgla_pathCuant2,
						model.getVersion().getPathCuant2());
			}
			...
			if (!GenericValidator.isBlankOrNull(model.getVersion().getEtiqCuant3())
				...
				FieldValidator.validateRequired(this, MessageI18nKey.rgla_etiqCuant3,
						model.getVersion().getEtiqCuant3());
				FieldValidator.validateRequired(this, MessageI18nKey.rgla_pathCuant3,
						model.getVersion().getPathCuant3());
			}
			...
			if (!GenericValidator.isBlankOrNull(model.getVersion().getEtiqCuant4())
				...
				FieldValidator.validateRequired(this, MessageI18nKey.rgla_etiqCuant4,
						model.getVersion().getEtiqCuant4());
				FieldValidator.validateRequired(this, MessageI18nKey.rgla_pathCuant4,
						model.getVersion().getPathCuant4());
			}
			...
			if (!GenericValidator.isBlankOrNull(model.getVersion().getEtiqCuant5())
				...
				FieldValidator.validateRequired(this, MessageI18nKey.rgla_etiqCuant5,
						model.getVersion().getEtiqCuant5());
				FieldValidator.validateRequired(this, MessageI18nKey.rgla_pathCuant5,
						model.getVersion().getPathCuant5());
			}
			...
			if (!GenericValidator.isBlankOrNull(model.getVersion().getEtiqCuant6())
				...
				FieldValidator.validateRequired(this, MessageI18nKey.rgla_etiqCuant6,
						model.getVersion().getEtiqCuant6());
				FieldValidator.validateRequired(this, MessageI18nKey.rgla_pathCuant6,
						model.getVersion().getPathCuant6());
			}
		}
	}
}
