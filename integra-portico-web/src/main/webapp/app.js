...
/*
 * .config(function($typeaheadProvider) { angular.extend($typeaheadProvider.defaults, { trigger :
 * 'focus', minLength : 1, limit : 5, delay : { show : 250, hide : 100 } }); })
 * .config(function($tabProvider) { angular.extend($tabProvider.defaults, { navClass : 'nav-pills'
 * }); })
 */
