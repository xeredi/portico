angular.module(
        ...
        [ "ngRoute", "mgcrea.ngStrap", "mgcrea.ngStrap.aside", "ui.bootstrap.tpls", "ui.bootstrap.tabs",
                ...
                "metamodelo", "facturacion", "item", "maestro", "servicio", "estadistica", "proceso",
                "seguridad" ])
 ...
 * angular.extend($typeaheadProvider.defaults, { trigger : 'focus', minLength :
 * 1, limit : 5, delay : { show : 250, hide : 100 } }); })
 * .config(function($tabProvider) { angular.extend($tabProvider.defaults, {
 * navClass : 'nav-pills' }); })
 */
