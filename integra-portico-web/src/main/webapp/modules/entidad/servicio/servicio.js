...
function config($routeProvider) {
    $routeProvider
            ...
            .when(
                    "/servicio/srvc/amarredep/generar/prepare",
                    {
            ...
            .when(
                    "/servicio/srvc/buquepesca/generar/prepare",
                    {
...
function SrvcGridController($http, $location, $routeParams, pageTitleService) {
    var vm = this;
...
function SamdGenerarController($http, $location, $routeParams, pageTitleService) {
    ...
    function initialize() {
        ...
        $http.post("servicio/amarredep/generar-prepare.action", {}).success(
                function(data) {
                });
...
function SbupGenerarController($http, $location, $routeParams, pageTitleService) {
    ...
    function initialize() {
        ...
        $http.post("servicio/buquepesca/generar-prepare.action", {}).success(
                function(data) {
                });
...
function SsrvGridController($http, $location, $routeParams, pageTitleService) {
    var vm = this;
