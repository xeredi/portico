...
function config($stateProvider) {
	...
	.state("tramite-create", {
		url : "/metamodelo/tramite/create/:entiId",
	...
	.state("tramite-edit", {
		url : "/metamodelo/tramite/edit/:id",
		templateUrl : "modules/metamodelo/tramite-edit.html",
		controller : "TramiteEditController as vm",
		data : {
			accion : 'edit'
	...
	.state("tramite-tipo-dato-detail", {
		url : "/metamodelo/tramite-tipo-dato/detail/:trmtId/:tpdtId",
		templateUrl : "modules/metamodelo/tramite-tipo-dato-detail.html",
		controller : "TramiteTipoDatoDetailController as vm",
	})

	.state("tramite-tipo-dato-create", {
		url : "/metamodelo/tramite-tipo-dato/create/:trmtId",
	...
	.state("tramite-tipo-dato-edit", {
		url : "/metamodelo/tramite-tipo-dato/edit/:trmtId/:tpdtId",
		templateUrl : "modules/metamodelo/tramite-tipo-dato-edit.html",
		controller : "TramiteTipoDatoEditController as vm",
		data : {
			accion : 'edit'
	...
	.state("accion-entidad-detail", {
		url : "/metamodelo/accion-entidad/detail/:id",
		templateUrl : "modules/metamodelo/accion-entidad-detail.html",
		controller : "AccionEntidadDetailController as vm",
	})

	.state("accion-entidad-create", {
		url : "/metamodelo/accion-entidad/create/:entiId",
	...
	.state("accion-entidad-edit", {
		url : "/metamodelo/accion-entidad/edit/:id",
		templateUrl : "modules/metamodelo/accion-entidad-edit.html",
		controller : "AccionEntidadEditController as vm",
		data : {
			accion : 'edit'
...
function TipoDatoGridController($state, $stateParams, $modal, pageTitleService,
		TipoDatoService) {
	var vm = this;
...
function TipoDatoDetailController($stateParams, pageTitleService,
		TipoDatoService) {
	var vm = this;
...
function TipoDatoEditController($state, $stateParams, pageTitleService,
		TipoDatoService) {
	var vm = this;
...
function CodigoReferenciaDetailController($stateParams, pageTitleService,
...
function CodigoReferenciaEditController($state, $stateParams, pageTitleService,
		CodigoReferenciaService) {
	var vm = this;
...
function TipoParametroGridController($state, $stateParams, $modal,
...
function TipoParametroDetailController($stateParams, pageTitleService,
...
function TipoParametroEditController($state, $stateParams, pageTitleService,
		TipoParametroService) {
	var vm = this;
...
function TipoSubparametroDetailController($stateParams, pageTitleService,
...
function TipoSubparametroEditController($state, $stateParams, pageTitleService,
		TipoSubparametroService) {
	var vm = this;
...
function TipoServicioGridController($state, $stateParams, $modal,
...
function TipoServicioDetailController($stateParams, pageTitleService,
		TipoServicioService) {
	var vm = this;
...
function TipoServicioEditController($state, $stateParams, pageTitleService,
		TipoServicioService) {
	var vm = this;
...
function TipoSubservicioDetailController($stateParams, pageTitleService,
...
function TipoSubservicioEditController($state, $stateParams, pageTitleService,
		TipoSubservicioService) {
	var vm = this;
...
function TipoEstadisticaGridController($state, $stateParams, $modal,
...
function TipoEstadisticaDetailController($stateParams, pageTitleService,
...
function TipoEstadisticaEditController($state, $stateParams, pageTitleService,
		TipoEstadisticaService) {
	var vm = this;
...
function CampoAgregacionDetailController($stateParams, pageTitleService,
...
function CampoAgregacionEditController($state, $stateParams, pageTitleService,
		CampoAgregacionService) {
	var vm = this;
...
function EntidadTipoDatoDetailController($stateParams, pageTitleService,
...
function EntidadTipoDatoEditController($state, $stateParams, pageTitleService,
		EntidadTipoDatoService) {
	var vm = this;
...
function EntidadGrupoDatoDetailController($stateParams, pageTitleService,
...
function EntidadGrupoDatoEditController($state, $stateParams, pageTitleService,
		EntidadGrupoDatoService) {
	var vm = this;
...
function TramiteDetailController($stateParams, pageTitleService, TramiteService) {
	...
	TramiteService.detail(vm.model).then(function(data) {
		vm.model = data.model;
		vm.i18nMap = data.i18nMap;
...
function TramiteEditController($state, $stateParams, pageTitleService,
		TramiteService) {
	var vm = this;
...
function TramiteTipoDatoDetailController($stateParams, pageTitleService,
	...
	TramiteTipoDatoService.detail(vm.model).then(function(data) {
		vm.model = data.model;
	});
...
function TramiteTipoDatoEditController($state, $stateParams, pageTitleService,
		TramiteTipoDatoService) {
	var vm = this;
...
function AccionEntidadDetailController($stateParams, pageTitleService,
	...
	AccionEntidadService.detail(vm.model).then(function(data) {
		vm.model = data.model;
...
function AccionEntidadEditController($state, $stateParams, pageTitleService,
		AccionEntidadService) {
	var vm = this;
...
function EntidadAccionDetailController($stateParams, pageTitleService,
...
function EntidadAccionEditController($state, $stateParams, pageTitleService,
		EntidadAccionService) {
	var vm = this;
...
function EntidadAccionGridDetailController($stateParams, pageTitleService,
...
function EntidadAccionGridEditController($state, $stateParams,
...
function EntidadEntidadEditController($state, $stateParams, pageTitleService,
