				...
				function(data) {
					vm.accion == 'edit' ? setTimeout(function() {
						window.history.back();
							...
							"/metamodelo/tpdt/detail/" + data.model.id)
							.replace();
				});
	}
				...
				function(data) {
					vm.accion == 'edit' ? setTimeout(function() {
						window.history.back();
							...
							"/metamodelo/cdrf/detail/" + data.model.id)
							.replace();
				});
	}
				...
				function(data) {
					vm.accion == 'edit' ? setTimeout(function() {
						window.history.back();
							...
							"/metamodelo/tppr/detail/" + data.model.id)
							.replace();
				});
	}
				...
				function(data) {
					vm.accion == 'edit' ? setTimeout(function() {
						window.history.back();
							...
							"/metamodelo/tpsp/detail/" + data.model.id)
							.replace();
				});
	}
				...
				function(data) {
					vm.accion == 'edit' ? setTimeout(function() {
						window.history.back();
							...
							"/metamodelo/tpsr/detail/" + data.model.id)
							.replace();
				});
	}
				...
				function(data) {
					vm.accion == 'edit' ? setTimeout(function() {
						window.history.back();
							...
							"/metamodelo/tpss/detail/" + data.model.id)
							.replace();
				});
	}
				...
				function(data) {
					vm.accion == 'edit' ? setTimeout(function() {
						window.history.back();
							...
							"/metamodelo/tpes/detail/" + data.model.id)
							.replace();
				});
	}
				...
				function(data) {
					vm.accion == 'edit' ? setTimeout(function() {
						window.history.back();
							...
							"/metamodelo/cmag/detail/" + data.model.tpesId
									+ "/" + data.model.entd.id).replace();
				});
	}
				...
				function(data) {
					vm.accion == 'edit' ? setTimeout(function() {
						window.history.back();
							...
							"/metamodelo/entd/detail/" + data.model.entiId
									+ "/" + data.model.tpdt.id).replace();
				});
	}
				...
				function(data) {
					vm.accion == 'edit' ? setTimeout(function() {
						window.history.back();
							...
							"/metamodelo/engd/detail/" + data.model.id)
							.replace();
				});
	}
				...
				function(data) {
					vm.accion == 'edit' ? setTimeout(function() {
						window.history.back();
							...
							"/metamodelo/enac/detail/" + data.model.id)
							.replace();
				});
	}
				...
				function(data) {
					vm.accion == 'edit' ? setTimeout(function() {
						window.history.back();
							...
							"/metamodelo/enag/detail/" + data.model.id)
							.replace();
				});
	}
	...
	function save() {
		$http.post("metamodelo/entidad-entidad-save.action", {
			...
			accion : vm.accion
				...
				function(data) {
					$location.path("/metamodelo/enen/detail/" + data.model.id)
							.replace();
				});
	}
