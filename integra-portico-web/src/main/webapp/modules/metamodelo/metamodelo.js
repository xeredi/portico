...
function tpdtDetailController($http, $routeParams, pageTitleService) {
	...
	function remove() {
		if (confirm("Are you sure?")) {
			$http.get("metamodelo/tpdt-remove.action?tpdt.id=" + vm.tpdt.id)
					.success(function(data) {
						window.history.back();
					});
		}
	...
	$http.get("metamodelo/tpdt-detail.action?tpdt.id=" + $routeParams.tpdtId)
			.success(function(data) {
				vm.tpdt = data.tpdt;
...
function tpdtEditController($http, $routeParams, pageTitleService) {
	...
	$http.get("metamodelo/tpdt-edit.action?tpdt.id=" + $routeParams.tpdtId)
			.success(function(data) {
				vm.tpdt = data.tpdt;
				vm.i18nMap = data.i18nMap;
				vm.accion = data.accion;
...
function cdrfCreateController($http, $location, $routeParams, pageTitleService) {
	...
	$http.get(
			"metamodelo/cdrf-create.action?cdrf.tpdtId=" + $routeParams.tpdtId)
			.success(function(data) {
				vm.cdrf = data.cdrf;
				vm.i18nMap = data.i18nMap;
				vm.accion = data.accion;
...
function cdrfDetailController($http, $location, $routeParams, pageTitleService) {
	...
	function remove() {
		if (confirm("Are you sure?")) {
			$http.get("metamodelo/cdrf-remove.action?cdrf.id=" + vm.cdrf.id)
					.success(function(data) {
						window.history.back();
					});
		}
	...
	$http.get("metamodelo/cdrf-detail.action?cdrf.id=" + $routeParams.cdrfId)
			.success(function(data) {
				vm.cdrf = data.cdrf;
				vm.i18nMap = data.i18nMap;
			});
...
function cdrfEditController($http, $routeParams, pageTitleService) {
	...
	$http.get("metamodelo/cdrf-edit.action?cdrf.id=" + $routeParams.cdrfId)
			.success(function(data) {
				vm.cdrf = data.cdrf;
				vm.i18nMap = data.i18nMap;
				vm.accion = data.accion;
...
function tpprDetailController($http, $location, $routeParams, pageTitleService) {
	...
	function remove() {
		if (confirm("Are you sure?")) {
			$http
					.get(
							"metamodelo/tppr-remove.action?enti.id="
									+ $scope.enti.id).success(function(data) {
						window.history.back();
					});
		}
	}

	$http.get("metamodelo/tppr-detail.action?enti.id=" + $routeParams.entiId)
			.success(function(data) {
				vm.enti = data.enti;
...
function tpprEditController($http, $routeParams, pageTitleService) {
	...
	$http
			.get("metamodelo/tppr-edit.action?enti.id=" + $routeParams.entiId)
			.success(
					function(data) {
						vm.enti = data.enti;
						vm.accion = data.accion;
...
function tpspDetailController($http, $routeParams, pageTitleService) {
	...
	function remove() {
		if (confirm("Are you sure?")) {
			$http.get("metamodelo/tpsp-remove.action?enti.id=" + vm.enti.id)
					.success(function(data) {
						window.history.back();
					});
		}
	...
	$http.get("metamodelo/tpsp-detail.action?enti.id=" + $routeParams.entiId)
			.success(function(data) {
				vm.enti = data.enti;
				vm.i18nMap = data.i18nMap;
			});
...
function tpspEditController($http, $routeParams, pageTitleService) {
	...
	$http.get("metamodelo/tpsp-edit.action?enti.id=" + $routeParams.entiId)
			.success(function(data) {
				vm.enti = data.enti;
				vm.i18nMap = data.i18nMap;
				vm.accion = data.accion;
...
function tpspCreateController($http, $location, $routeParams, pageTitleService) {
	...
	$http.get(
			"metamodelo/tpsp-create.action?enti.tpprId=" + $routeParams.tpprId)
			.success(function(data) {
				vm.enti = data.enti;
				vm.accion = data.accion;
			});
...
function tpsrDetailController($http, $routeParams, pageTitleService) {
	...
	function remove() {
		if (confirm("Are you sure?")) {
			$http.get("metamodelo/tpsr-remove.action?enti.id=" + vm.enti.id)
					.success(function(data) {
						window.history.back();
					});
		}
	...
	$http.get("metamodelo/tpsr-detail.action?enti.id=" + $routeParams.entiId)
			.success(function(data) {
				vm.enti = data.enti;
				vm.i18nMap = data.i18nMap;
				vm.subentiList = data.subentiList;
...
function tpsrEditController($http, $routeParams, pageTitleService) {
	...
	$http.get("metamodelo/tpsr-edit.action?enti.id=" + $routeParams.entiId)
			.success(function(data) {
				vm.enti = data.enti;
				vm.i18nMap = data.i18nMap;
				vm.accion = data.accion;
	...
	$http.get("metamodelo/tpdt-lv-list.action?tpdtCriterio.tipoElemento=CR")
			.success(function(data) {
...
function tpssDetailController($http, $routeParams, pageTitleService) {
	...
	function remove() {
		if (confirm("Are you sure?")) {
			$http.get("metamodelo/tpss-remove.action?enti.id=" + vm.enti.id)
					.success(function(data) {
						window.history.back();
					});
		}
	...
	$http.get("metamodelo/tpss-detail.action?enti.id=" + $routeParams.entiId)
			.success(function(data) {
				vm.enti = data.enti;
				vm.i18nMap = data.i18nMap;
				vm.entiHijasList = data.entiHijasList;
...
function tpssEditController($http, $routeParams, pageTitleService) {
	...
	$http.get("metamodelo/tpss-edit.action?enti.id=" + $routeParams.entiId)
			.success(function(data) {
				vm.enti = data.enti;
				vm.i18nMap = data.i18nMap;
				vm.accion = data.accion;
...
function tpssCreateController($scope, $http, $location, $routeParams,
	...
	$http.get(
			"metamodelo/tpss-create.action?enti.tpsrId=" + $routeParams.tpsrId)
			.success(function(data) {
				vm.enti = data.enti;
				vm.accion = data.accion;
			});
...
function tpesDetailController($http, $routeParams, pageTitleService) {
	...
	function remove() {
		if (confirm("Are you sure?")) {
			$http.get("metamodelo/tpes-remove.action?enti.id=" + vm.enti.id)
					.success(function(data) {
						window.history.back();
					});
		}
	...
	$http.get("metamodelo/tpes-detail.action?enti.id=" + $routeParams.entiId)
			.success(function(data) {
				vm.enti = data.enti;
				vm.i18nMap = data.i18nMap;
				vm.subentiList = data.subentiList;
...
function tpesEditController($http, $routeParams, pageTitleService) {
	...
	$http.get("metamodelo/tpes-edit.action?enti.id=" + $routeParams.entiId)
			.success(function(data) {
				vm.enti = data.enti;
				vm.i18nMap = data.i18nMap;
				vm.accion = data.accion;
...
function entdDetailController($http, $routeParams, pageTitleService) {
	...
	$http.get(
			"metamodelo/entd-detail.action?entd.entiId=" + $routeParams.entiId
...
function entdEditController($http, $routeParams, pageTitleService) {
	...
	$http.get(
			"metamodelo/entd-edit.action?entd.entiId=" + $routeParams.entiId
					+ "&entd.tpdt.id=" + $routeParams.tpdtId).success(
			function(data) {
				vm.entd = data.entd;
				vm.accion = data.accion;
...
function entdCreateController($http, $location, $routeParams, pageTitleService) {
	...
	$http.get(
			"metamodelo/entd-create.action?entd.entiId=" + $routeParams.entiId)
			.success(function(data) {
				vm.entd = data.entd;
				vm.tpdtList = data.tpdtList;
				vm.engdList = data.engdList;
...
function engdDetailController($scope, $http, $location, $routeParams,
		pageTitleService) {
	var vm = this;
	...
	function remove() {
		if (confirm("Are you sure?")) {
			$http.get("metamodelo/engd-remove.action?engd.id=" + vm.engd.id)
					.success(function(data) {
						window.history.back();
					});
		}
	...
	$http.get("metamodelo/engd-detail.action?engd.id=" + $routeParams.engdId)
			.success(function(data) {
				vm.engd = data.engd;
				vm.i18nMap = data.i18nMap;
			});
...
function engdEditController($http, $routeParams, pageTitleService) {
	...
	$http.get("metamodelo/engd-edit.action?engd.id=" + $routeParams.engdId)
			.success(function(data) {
				vm.engd = data.engd;
				vm.i18nMap = data.i18nMap;
				vm.accion = data.accion;
...
function engdCreateController($http, $location, $routeParams, pageTitleService) {
	...
	$http.get(
			"metamodelo/engd-create.action?engd.entiId=" + $routeParams.entiId)
			.success(function(data) {
				vm.engd = data.engd;
				vm.accion = data.accion;
			});
...
function enacDetailController($scope, $http, $location, $routeParams,
	...
	function remove() {
		if (confirm("Are you sure?")) {
			$http.get(
					"metamodelo/enac-remove.action?enac.entiId="
							+ vm.enac.entiId + "&enac.path=" + vm.enac.path)
					.success(function(data) {
						window.history.back();
					});
		}
	...
	$http.get(
			"metamodelo/enac-detail.action?enac.entiId=" + $routeParams.entiId
					+ "&enac.path=" + $routeParams.path).success(
			function(data) {
				vm.enac = data.enac;
			});
...
function enacEditController($http, $routeParams, pageTitleService) {
	...
	$http.get(
			"metamodelo/enac-edit.action?enac.entiId=" + $routeParams.entiId
					+ "&enac.path=" + $routeParams.path).success(
			function(data) {
				vm.enac = data.enac;
				vm.accion = data.accion;
...
function enacCreateController($http, $location, $routeParams, pageTitleService) {
	...
	function save() {
		$http.post("metamodelo/enac-save.action", {
			...
			accion : vm.accion
				...
				function(data) {
					$location.path(
							"/metamodelo/enac/detail/" + data.enac.entiId + "/"
									+ data.enac.path).replace();
				});
	}
	...
	$http.get(
			"metamodelo/enac-create.action?enac.entiId=" + $routeParams.entiId)
			.success(function(data) {
				vm.enac = data.enac;
				vm.accion = data.accion;
			});
...
function enenCreateController($http, $routeParams, pageTitleService) {
	...
	$http.get(
			"metamodelo/enen-create.action?enen.entiPadreId="
					+ $routeParams.entipId).success(function(data) {
		vm.enen = data.enen;
	});

	$http.get("metamodelo/enti-lv-list.action?entiCriterio.tipo=S").success(
			function(data) {
				vm.entiList = data.lvList;
			});
