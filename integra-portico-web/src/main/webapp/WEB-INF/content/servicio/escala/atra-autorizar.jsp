...
<html>
<head>
<title><fmt:message key="atra.autorizar.title" /></title>
</head>
<body>
    <form action="atra-autorizar-guardar.action" method="post">
        ...
        <div class="controls">
            <button type="submit" class="btn btn-primary">
                ...
                <fmt:message key="boton.autorizar" />
            </button>
        </div>
    </form>
</body>
