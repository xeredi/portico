...
public final class Test2Test {
    ...
    private void test(final String expression) throws IOException {
        ...
        final Test2Lexer lexer = new Test2Lexer(input);
        final CommonTokenStream tokens = new CommonTokenStream(lexer);
        final Test2Parser parser = new Test2Parser(tokens);
        ...
        final Test2SqlGenerator extractor = new Test2SqlGenerator(contextoVO);
