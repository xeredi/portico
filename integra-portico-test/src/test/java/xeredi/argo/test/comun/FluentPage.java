...
public abstract class FluentPage {
    ...
    protected final FluentSelect selectValue(final String cssSelector, final Boolean value) {
        final FluentSelect select = select(cssSelector);

        if (value != null) {
            select.selectByValue("boolean:" + value);
        }
     ...
     */
    public final FluentPage setI18nText(final String language, final String text) {
     ...
     * @return the tipo dato edit page
     */
    public final FluentPage setI18nText(final String text) {
        setI18nText("default_language", text);
