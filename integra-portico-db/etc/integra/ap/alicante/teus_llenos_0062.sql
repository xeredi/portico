CREATE OR REPLACE VIEW TEUS_LLENOS_0062 (
...
GROUP BY
	MANI.MANI_ID, SMAN.SERV_SUBP_ID, SUBPSMAN.SUBP_CODIGO, SMAN.SERV_ANNO, SMAN.SERV_NUMERO
	, MANI.MANI_FECHA_REFERENCIA , MACO_CONSIGNATARIO_SUBP_ID , SUBPMACO.SUBP_CODIGO
	, MACO_CONSIGNATARIO_ID , ORGAMACO.ORGA_COD , ORGAMACO.ORGA_NOMBRE , mabl.mabl_id
	, mabl.mabl_tipo, mabl.mabl_orden
;


DROP VIEW TEUS_LLENOS_0062;
CREATE MATERIALIZED VIEW TEUS_LLENOS_0062 (
	SMAN_ID, SMAN_SUBP_ID, SMAN_SUBP_CODIGO, SMAN_ANNO, SMAN_NUMERO, SMAN_FECHA, PAGADOR_SUBP_ID
	, PAGADOR_SUBP_CODIGO, PAGADOR_ID, PAGADOR_COD, PAGADOR_NOMBRE, MABL_ID, MABL_TIPO, MABL_ORDEN
	, EQUITEUS, EQUIUNIDADES
) AS
...
ALTER MATERIALIZED VIEW TEUS_LLENOS_0062 REFRESH COMPLETE ON DEMAND
