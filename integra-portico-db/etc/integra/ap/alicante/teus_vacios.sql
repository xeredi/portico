--------------------------------------------------------
--  DDL for View TEUS_VACIOS
--------------------------------------------------------

CREATE OR REPLACE VIEW TEUS_VACIOS (
...
GROUP BY
	MANI.MANI_ID, SMAN.SERV_SUBP_ID, SUBPSMAN.SUBP_CODIGO, SMAN.SERV_ANNO, SMAN.SERV_NUMERO, MANI.MANI_FECHA_REFERENCIA
	, MACO_CONSIGNATARIO_SUBP_ID , SUBPMACO.SUBP_CODIGO , MACO_CONSIGNATARIO_ID , ORGAMACO.ORGA_COD
	, ORGAMACO.ORGA_NOMBRE , mabl.mabl_id, mabl.mabl_tipo, mabl.mabl_orden
;

SELECT * FROM TEUS_VACIOS;
SELECT * FROM TEUS_VACIOS_5;
...
CREATE OR REPLACE VIEW TEUS_VACIOS_5 (
