...
-- Mensajes i18n
CREATE TABLE portico.tbl_message_mesg (
...
GRANT SELECT ON portico.tbl_message_mesg TO portico\
...
CREATE TABLE portico.tbl_message_i18n_m18n (
	...
	, CONSTRAINT fk_m18n_mesg_key FOREIGN KEY (m18n_key)
		REFERENCES portico.tbl_message_mesg (mesg_key)
)\

GRANT SELECT, INSERT, DELETE ON portico.tbl_message_i18n_m18n TO portico\
...
INSERT INTO portico.tbl_message_mesg (mesg_internal, mesg_key) VALUES (0, 'trmt_estado')\
	INSERT INTO portico.tbl_message_i18n_m18n (m18n_language, m18n_key, m18n_value) VALUES ('es', 'trmt_estado', 'Texto')\
...
INSERT INTO portico.tbl_message_mesg (mesg_internal, mesg_key) VALUES (0, 'vlrc_fref')\
	INSERT INTO portico.tbl_message_i18n_m18n (m18n_language, m18n_key, m18n_value) VALUES ('es', 'vlrc_fref', 'F. Referencia')\
...
DROP TABLE portico.tbl_message_mesg\
