...
CREATE LOGIN porticoadm WITH PASSWORD = 'portico';
CREATE LOGIN portico WITH PASSWORD = 'portico';

CREATE DATABASE portico;

use portico;
CREATE USER [porticoadm] FOR LOGIN [porticoadm];
CREATE USER [portico] FOR LOGIN [portico];
exec sp_addrolemember 'db_owner', 'porticoadm';
exec sp_addrolemember 'db_datareader', 'portico';
exec sp_addrolemember 'db_datawriter', 'portico';
